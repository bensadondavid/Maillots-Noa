...
const NewArrivals = ()=>{
    ...
    const SubmitForm = async(e)=>{
        e.preventDefault()
        try{
        const response =  await fetch('http://localhost:4000/news-arrivals', {
            method : 'POST',
    ...
    return(
        ...
        <div className="New-arrivals">
            ...
            Filters </button>
                <form method="POST" className="filters-form" onSubmit={SubmitForm}>
                    ...
                    <input type="number" className="price" placeholder="Price-max" name="price" value={filters.price} onChange={HandleChange}/>
